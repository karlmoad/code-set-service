...
Test('/code', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
        ...
        /**
         * summary: Remove and existing code
         * description: 
         * parameters: body
         * produces: application/json
         * responses: 200, 400
         */
        t.test('test remCode delete operation', function (t) {
            Mockgen().requests({
                path: '/code',
                operation: 'delete'
            }, function (err, mock) {
         ...
         * summary: Add/Update an existing code
         * description: 
         * parameters: body
         * produces: application/json
         * responses: 200, 404
         */
        t.test('test setCode put operation', function (t) {
            Mockgen().requests({
                path: '/code',
                operation: 'put'
            }, function (err, mock) {
