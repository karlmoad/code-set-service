...
/**
 * Test for /codes/{setId}
 */
Test('/codes/{setId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getCodeSet get operation', function (t) {
            Mockgen().requests({
                path: '/codes/{setId}',
                operation: 'get'
            }, function (err, mock) {
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/codes/{setId}']['get']['responses']['200']['schema']);
