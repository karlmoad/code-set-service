...
/**
 * Test for /code/{setId}/{codeId}
 */
Test('/code/{setId}/{codeId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getCode get operation', function (t) {
            Mockgen().requests({
                path: '/code/{setId}/{codeId}',
                operation: 'get'
            }, function (err, mock) {
                var request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/code/{setId}/{codeId}']['get']['responses']['200']['schema']);
